...
const HeaderMenu = () => {
  ...
  switch (menuType) {
    ...
    case MENU_TYPE.CONTACT:
      ...
      questionsActiveLink = ``;
      break;
    case MENU_TYPE.QUESTIONS:
      servicesActiveLink = ``;
      loanActiveLink = ``;
      converterActiveLink = ``;
      contactActiveLink = ``;
      questionsActiveLink = `page-menu__link--active`;
      break;
  }
      ...
      <ul className="page-menu__list">
        ...
        <li className="page-menu__item">
          <Link
            ...
            className={`page-menu__link ${questionsActiveLink}`}
            onClick={()=> {
              dispatch(changeMenu(MENU_TYPE.QUESTIONS));
            }}
          >
            Задать вопрос
          </Link>
